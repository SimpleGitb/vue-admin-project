<template>
    <div class="threatview">
                ...
                <div>
                    <el-tabs v-model="activeName2" @tab-click="tabclick">
                        <el-tab-pane label="最新威胁" name="threat">
                            ...
                            <div class="right">
                                 <el-input placeholder="请输入内容" v-model="select_word" class="input-with-select">
                                    ...
                                    <!-- <div class="tips" ref="tips" :style="{left:tipsLeft,top:tipsTop,display:display}">
                                     ...
                                     <el-table border v-loading="loading"  ref="multipleTable" :data="tableData3" tooltip-effect="dark"  @selection-change="handleSelectionChange">
                                        ...
                                        <el-table-column prop="" label="快照" width="60">
                                            <template slot-scope="scope">
                                                <a :href="scope.row.cache" target="_blank"> <i class="iconfont kuaizhao">&#xe609;</i></a>                                           
                                             </template>
                                        </el-table-column>
                                                            ...
                                                            <el-dropdown>
                                                             ...
                                                             <el-dropdown-menu slot="dropdown">
                                                                 ...
                                                                 <el-dropdown-item v-if="scope.row.type == 'site' || scope.row.type == 'hijack'">
                                                                      <template>
                                                                            <a style="color: #5a5e66;" :href="'/api/threat/'+scope.row.id+'/export'">导出</a>
                                                                     </template>
                                                                 </el-dropdown-item>
                                                             </el-dropdown-menu>
                                                             </el-dropdown>
                        ...
                        <el-tab-pane label="待处置" class="waiteSetting" name="waiteSetting">
                            ...
                            <div class="right">
                                 <el-input placeholder="请输入内容" v-model="select_word1" class="input-with-select">
                                    ...
                                    <el-table-column prop="" label="操作" width="150">
                                        <template slot-scope="scope">
                                            <div class="btn-list">
                                                    ...
                                                    <div class="btn">
                                                        <a class="list-item orange" :href="'/api/threat/'+scope.row.id+'/export'">导出</a>
                                                    </div>
                                            </div>
                                        </template> 
                                    </el-table-column>
                        ...
                        <el-tab-pane label="已处置" name="disposal">
                            ...
                            <div class="right">
                                 <el-input placeholder="请输入内容" v-model="select_word2" class="input-with-select">
                        ...
                        <el-tab-pane label="误报回收站" class="positivesRecycling" name="positives">
                             <div class="left_l">
                                ...
                                <div class="right">
                                 <el-input placeholder="请输入内容" v-model="select_word3" class="input-with-select">
        ...
        <el-dialog title="信息" :visible.sync="editVisible" width="35%" class="confrim">
        ...
        <el-dialog title="信息" :visible.sync="ignoreVisible" width="35%">
                    <el-form :label-position="labelPosition" label-width="100px">
                            <el-form-item>
        ...
        <el-dialog title="信息" :visible.sync="positives" width="35%">
            <el-form :label-position="labelPosition" label-width="100px">
                <el-form-item>
        ...
        <el-dialog title="信息" :visible.sync="undoVisible" width="35%">
            <el-form :label-position="labelPosition" label-width="100px">
                <el-form-item>
        ...
        <el-dialog title="信息" :visible.sync="disposalVisible" width="35%">
            <el-form :label-position="labelPosition" label-width="100px">
                <el-form-item>
...
<script>
    export default {
        ...
        methods: {
            saveEdit(){
                this.$axios.post('api/threat/'+this.id+'/confirm',{
            ...
            saveEditdisposal(){
                this.$axios.post('api/threat/'+this.disposalId+'/ignore').then((res)=>{
                    if(!res.data.status){
                        this.$message.error(res.data.msg);
                    }else{
                        this.$message.success(res.data.msg);
            ...
            selectType1(d){
                this.loading = true;
                this.type1 = d;
                this.$axios.get('api/threat?page=1&limit=10&type='+d+'&search='+this.select_word).then((res)=>{
            ...
            selectType2(d){
                this.loading1 = true;
                this.type2 = d;
                 this.$axios.get("api/threat?page=1&limit=10&deal=1&type="+d+'&search='+this.select_word1).then((res)=>{ 
                    let data = res.data;
            ...
            selectType3(d){
                this.loading2 = true;
                this.type3 = d;
                this.$axios.get('api/threat?page=1&limit=10&where=deal&type='+d+'&search='+this.select_word2).then((res)=>{
            ...
            selectType4(d){
                this.loading3 = true;
                this.type4 = d;
                this.$axios.get('api/threat?page=1&limit=10&where=check&type='+d+'&search='+this.select_word3).then((res)=>{
            ...
            changepage(t){
                this.loading = true;
               this.$axios.get("api/threat?page="+t+"&limit=10&search="+this.select_word+"&type="+this.type1).then((res)=>{
                        let data = res.data;
            ...
            changepage1(t){
               this.loading1 = true;
               this.$axios.get("api/threat?page="+t+"&limit=10&search="+this.select_word1+"&deal=1&type="+this.type2).then((res)=>{
                        let data = res.data;
                        this.tableData4 = data.data.data;
            ...
            changepage2(t){
               this.loading2 = true;
               this.$axios.get("api/threat?page="+t+"&limit=10&search="+this.select_word2+"&where=deal&type="+this.type3).then((res)=>{
                        let data = res.data;
            ...
            changepage3(t){
               this.loading3 = true;
               this.$axios.get("api/threat?page="+t+"&limit=10&search="+this.select_word3+"&where=check&type="+this.type4).then((res)=>{
                        let data = res.data;
            ...
            sendSearch() {
                ...
                // }else{
                     this.loading = true;
                     this.$axios.get("api/threat?page=1&limit=10&search="+this.select_word+"&type="+this.type1).then((res)=>{ 
                            this.tableData3 = (res.data.data.data);
                            this.totalpage = res.data.data.count;
                            this.loading = false;
                        }).catch(v => {
            ...
            sendSearch1() {
                ...
                // }else{
                     this.loading1 = true;
                     this.$axios.get("api/threat?page=1&limit=10&search="+this.select_word1+"&deal=1&type="+this.type2).then((res)=>{ 
            ...
            sendSearch2() {
                ...
                // }else{
                     this.loading2 = true;
                     this.$axios.get("api/threat?page=1&limit=10&search="+this.select_word2+"&where=deal&type="+this.type3).then((res)=>{ 
                            this.tableData5 = (res.data.data.data);
                            this.totalpage2 = res.data.data.count;
                            this.loading2 = false;
                        }).catch(v => {
            ...
            sendSearch3() {
                ...
                // }else{
                     this.loading3 = true;
                     this.$axios.get("api/threat?page=1&limit=10&search="+this.select_word3+"&where=check&type="+this.type4).then((res)=>{ 
                            this.tableData6 = (res.data.data.data);
                            this.totalpage3 = res.data.data.count;
                            this.loading3 = false;
                        }).catch(v => {
            ...
            getDeal(){
                this.loading1 = true;
                this.$axios.get("api/threat?page=1&limit=10&deal=1").then((res)=>{ 
                    let data = res.data;
                    this.totalpage1 = Math.ceil(data.data.count);
                    this.tableData4 = data.data.data;
                    this.loading1 = false;
            ...
            getpositives(){
                    this.loading2 = true;
                    this.$axios.get("api/threat?limit=10&page=1&where=deal").then((res)=>{ 
                        let data = res.data;
                        this.totalpage2 = Math.ceil(data.data.count);
                        this.tableData5 = data.data.data;
                        this.loading2 = false;
