    ...
    <div class="login login1" :class="rotate">
        ...
        <div class="login_fields">
            <div class="login_fields__user">
                ...
                <input name="login" id="username" v-model="ruleForm.username" style="font-family: 微软雅黑;font-size: 14px;" placeholder="邮箱"
                    type="username">
            </div>
            <div class="login_fields__password">
                ...
                <input name="pwd" id="password" v-model="ruleForm.password" style="font-family: 微软雅黑;font-size: 14px;"
